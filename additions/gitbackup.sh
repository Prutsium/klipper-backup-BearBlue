...
push_config(){
  ...
  git commit -m "Bear Blue autocommit from $current_date" -m "$m1" -m "$m2" -m "$m3" -m "$m4"
  git push "https://Prutsium:$GH_TOKEN@github.com/Prutsium/klipper-backup-BearBlue.git"
#  git push
}
